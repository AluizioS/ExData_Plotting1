...
## Top left
plot(power.df$Time, power.df$Global_active_power, ylab="Global Active Power", 
     xlab=" ", type='l')

## Top right
plot(power.df$Time, power.df$Voltage, ylab="Voltage", xlab="datetime",  type="l")

## Bottom left
plot(power.df$Time, power.df$Sub_metering_1, ylab="Energy sub metering", xlab=" ",
     type="l")
lines(power.df$Time, power.df$Sub_metering_2, col="red")
lines(power.df$Time, power.df$Sub_metering_3, col="blue")
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"),
       col=c("black", "red", "blue"), lty="solid", bty="n")

## Bottom right
plot(power.df$Time, power.df$Global_reactive_power, ylab="Global_reactive_power", 
